...
@overload  # generic
def convolve[AnyShapeT: (tuple[int], tuple[int, int], tuple[int, int, int]), NumericT: npc.number | np.bool](
...
@overload  # generic
def correlate[AnyShapeT: (tuple[int], tuple[int, int], tuple[int, int, int]), NumericT: npc.number | np.bool](
    in1: nptc.CanArray[AnyShapeT, np.dtype[NumericT]],
    in2: nptc.CanArray[AnyShapeT, np.dtype[NumericT]],
    mode: onp.ConvolveMode = "full",
    method: _ToConvMethod = "auto",
...
def fftconvolve[AnyShapeT: (tuple[int], tuple[int, int], tuple[int, int, int])](
...
def fftconvolve[
    ...
    AnyShapeT: (tuple[int], tuple[int, int], tuple[int, int, int]),
](
...
@overload  # float64 | integer | bool, float64 | integer | bool, generic shape
def oaconvolve[AnyShapeT: (tuple[int], tuple[int, int], tuple[int, int, int])](
    in1: onp.ArrayND[npc.floating64 | npc.integer | np.bool, AnyShapeT],
    in2: onp.ArrayND[npc.floating64 | npc.integer | np.bool, AnyShapeT],
    mode: onp.ConvolveMode = "full",
    axes: None = None,
