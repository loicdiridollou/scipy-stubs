...
def describe[IntegerT: npc.integer](
    a: onp.ArrayND[IntegerT], axis: None, ddof: int = 1, bias: bool = True, nan_policy: NanPolicy = "propagate"
) -> DescribeResult[IntegerT, np.float64]: ...
...
def describe[IntegerT: npc.integer](
    a: onp.ArrayND[IntegerT, _JustAnyShape], axis: int = 0, ddof: int = 1, bias: bool = True, nan_policy: NanPolicy = "propagate"
) -> DescribeResult[IntegerT | onp.ArrayND[IntegerT], np.float64 | onp.ArrayND[np.float64]]: ...
...
def describe[IntegerT: npc.integer](
    a: onp.Array1D[IntegerT], axis: int | None = 0, ddof: int = 1, bias: bool = True, nan_policy: NanPolicy = "propagate"
) -> DescribeResult[IntegerT, np.float64]: ...
...
def describe[IntegerT: npc.integer](
    a: onp.Array2D[IntegerT], axis: int = 0, ddof: int = 1, bias: bool = True, nan_policy: NanPolicy = "propagate"
) -> DescribeResult[onp.Array1D[IntegerT], onp.Array1D[np.float64]]: ...
...
#
@overload
def sigmaclip[IntegerT: npc.integer](
    a: onp.ArrayND[IntegerT], low: float = 4.0, high: float = 4.0, *, nan_policy: NanPolicy = "propagate"
) -> SigmaclipResult[IntegerT, np.float64]: ...
@overload
...
@overload  # ?d ~T
def ttest_ind[AnyFloatSub64T: np.float32 | np.float16](
    a: onp.ArrayND[AnyFloatSub64T, _JustAnyShape],
    b: onp.ArrayND[AnyFloatSub64T, _JustAnyShape],
    *,
    axis: int = 0,
    equal_var: bool = True,
    nan_policy: NanPolicy = "propagate",
    ...
    method: ResamplingMethod | None = None,
    keepdims: L[False] = False,
) -> TtestResult[AnyFloatSub64T | Any]: ...
@overload  # 1d ~f64
def ttest_ind(
    a: onp.ToArrayStrict1D[float, npc.floating64 | npc.integer | np.bool],
...
@overload  # 1d ~T
def ttest_ind[AnyFloatSub64T: np.float32 | np.float16](
    a: onp.ToArrayStrict1D[AnyFloatSub64T, AnyFloatSub64T],
    b: onp.ToArrayStrict1D[AnyFloatSub64T, AnyFloatSub64T],
    *,
    axis: int = 0,
    equal_var: bool = True,
    nan_policy: NanPolicy = "propagate",
...
@overload  # 2d ~T
def ttest_ind[AnyFloatSub64T: np.float32 | np.float16](
    a: onp.ToArrayStrict2D[AnyFloatSub64T, AnyFloatSub64T],
    b: onp.ToArrayStrict2D[AnyFloatSub64T, AnyFloatSub64T],
    *,
    axis: int = 0,
    equal_var: bool = True,
    nan_policy: NanPolicy = "propagate",
    ...
    method: ResamplingMethod | None = None,
    keepdims: L[False] = False,
) -> TtestResult[onp.Array1D[AnyFloatSub64T]]: ...
...
@overload  # 3d ~T
def ttest_ind[AnyFloatSub64T: np.float32 | np.float16](
    a: onp.ToArrayStrict3D[AnyFloatSub64T, AnyFloatSub64T],
    b: onp.ToArrayStrict3D[AnyFloatSub64T, AnyFloatSub64T],
    *,
    axis: int = 0,
    equal_var: bool = True,
    nan_policy: NanPolicy = "propagate",
    ...
    method: ResamplingMethod | None = None,
    keepdims: L[False] = False,
) -> TtestResult[onp.Array2D[AnyFloatSub64T]]: ...
...
@overload  # nd ~T, axis=None
def ttest_ind[AnyFloatSub64T: np.float32 | np.float16](
    a: onp.ToArrayND[AnyFloatSub64T, AnyFloatSub64T],
    b: onp.ToArrayND[AnyFloatSub64T, AnyFloatSub64T],
    *,
    axis: None,
    equal_var: bool = True,
    nan_policy: NanPolicy = "propagate",
...
def ttest_ind[AnyFloatSub64T: np.float32 | np.float16](
    ...
    *,
    ...
    method: ResamplingMethod | None = None,
    keepdims: L[True],
) -> TtestResult[onp.ArrayND[AnyFloatSub64T]]: ...
@overload  # nd +floating, axis=None
def ttest_ind(
    a: onp.ToFloatND,
    b: onp.ToFloatND,
...
@overload  # ?d ~T
def ttest_rel[AnyFloatSub64T: np.float32 | np.float16](
    a: onp.ArrayND[AnyFloatSub64T, _JustAnyShape],
    b: onp.ArrayND[AnyFloatSub64T, _JustAnyShape],
    axis: int = 0,
    nan_policy: NanPolicy = "propagate",
