...
class UnivariateDistribution(_BaseDistribution[_XT_co], Generic[_XT_co, _ShapeT0_co]):
    ...
    @overload
    def __add__(self: _DistT, x: onp.CanArrayND[_FloatT, _ShapeT1], /) -> _LinDist[_DistT, _FloatT | _FloatT_co, _ShapeT1]: ...
    @overload
    ...
    @overload
    def __sub__(
        self: _DistT, lshift: onp.CanArrayND[_FloatT, _ShapeT1], /
    ) -> _LinDist[_DistT, _FloatT | _FloatT_co, _ShapeT1]: ...
    @overload
    ...
    @overload
    def __mul__(
        self: _DistT, scale: onp.CanArrayND[_FloatT, _ShapeT1], /
    ) -> _LinDist[_DistT, _FloatT | _FloatT_co, _ShapeT1]: ...
    @overload
    ...
    @overload
    def __truediv__(
        self: _DistT, iscale: onp.CanArrayND[_FloatT, _ShapeT1], /
    ) -> _LinDist[_DistT, _FloatT | _FloatT_co, _ShapeT1]: ...
    @overload
