...
def expand_dims[SCT: _Numeric](  # type: ignore[overload-overlap]
    A: sparray[SCT, tuple[Never] | tuple[Never, Never]], /, *, axis: int = 0
) -> coo_array[SCT, tuple[int, int, *tuple[Any, ...]]]: ...
@overload
def expand_dims[SCT: _Numeric](A: sparray[SCT, tuple[int]], /, *, axis: int = 0) -> coo_array[SCT, tuple[int, int]]: ...
@overload
def expand_dims[SCT: _Numeric](A: sparray[SCT, tuple[int, int]], /, *, axis: int = 0) -> coo_array[SCT, tuple[int, int, int]]: ...
@overload
def expand_dims[SCT: _Numeric](
    A: sparray[SCT, tuple[int, int, int]], /, *, axis: int = 0
) -> coo_array[SCT, tuple[int, int, int, int]]: ...
@overload  # TODO(@jorenham): shape-typing for coo_matrix
def expand_dims[SCT: _Numeric](A: spmatrix[SCT], /, *, axis: int = 0) -> coo_matrix[SCT]: ...

#
@overload
def swapaxes[SCT: _Numeric, ShapeT: tuple[int, *tuple[int, ...]]](
    A: sparray[SCT, ShapeT], axis1: int, axis2: int
) -> coo_array[SCT, ShapeT]: ...
@overload  # TODO(@jorenham): shape-typing for coo_matrix
def swapaxes[SCT: _Numeric](A: spmatrix[SCT], axis1: int, axis2: int) -> coo_matrix[SCT]: ...

#
@overload
def permute_dims[SCT: _Numeric, ShapeT: tuple[int, *tuple[int, ...]]](
    A: sparray[SCT, ShapeT], axes: Seq[int] | None = None, copy: bool = False
) -> coo_array[SCT, ShapeT]: ...
@overload  # TODO(@jorenham): shape-typing for coo_matrix
def permute_dims[SCT: _Numeric](A: spmatrix[SCT], axes: Seq[int] | None = None, copy: bool = False) -> coo_matrix[SCT]: ...
...
def diags_array[SCT: _Numeric](
    diagonals: _ToArray1D2D[SCT],
    /,
    *,
    offsets: _Offsets = 0,
    shape: tuple[int, int] | None = None,
...
@overload
def spdiags[SCT: _Numeric](
    data: _ToArray1D2D[SCT], diags: _Offsets, m: int, n: int, format: _FmtDIA | None = None
) -> dia_matrix[SCT]: ...
@overload
def spdiags[SCT: _Numeric](data: _ToArray1D2D[SCT], diags: _Offsets, m: int, n: int, format: _FmtBSR) -> bsr_matrix[SCT]: ...
@overload
def spdiags[SCT: _Numeric](data: _ToArray1D2D[SCT], diags: _Offsets, m: int, n: int, format: _FmtCOO) -> coo_matrix[SCT]: ...
@overload
def spdiags[SCT: _Numeric](data: _ToArray1D2D[SCT], diags: _Offsets, m: int, n: int, format: _FmtCSC) -> csc_matrix[SCT]: ...
@overload
def spdiags[SCT: _Numeric](data: _ToArray1D2D[SCT], diags: _Offsets, m: int, n: int, format: _FmtCSR) -> csr_matrix[SCT]: ...
@overload
def spdiags[SCT: _Numeric](data: _ToArray1D2D[SCT], diags: _Offsets, m: int, n: int, format: _FmtDOK) -> dok_matrix[SCT]: ...
@overload
def spdiags[SCT: _Numeric](data: _ToArray1D2D[SCT], diags: _Offsets, m: int, n: int, format: _FmtLIL) -> lil_matrix[SCT]: ...

#
@overload
def spdiags[SCT: _Numeric](
    data: _ToArray1D2D[SCT], diags: _Offsets, m: tuple[int, int] | None = None, n: None = None, format: _FmtDIA | None = None
) -> dia_matrix[SCT]: ...
@overload
def spdiags[SCT: _Numeric](
    data: _ToArray1D2D[SCT], diags: _Offsets, m: tuple[int, int] | None = None, n: None = None, *, format: _FmtBSR
) -> bsr_matrix[SCT]: ...
@overload
def spdiags[SCT: _Numeric](
    data: _ToArray1D2D[SCT], diags: _Offsets, m: tuple[int, int] | None = None, n: None = None, *, format: _FmtCOO
) -> coo_matrix[SCT]: ...
@overload
def spdiags[SCT: _Numeric](
    data: _ToArray1D2D[SCT], diags: _Offsets, m: tuple[int, int] | None = None, n: None = None, *, format: _FmtCSC
) -> csc_matrix[SCT]: ...
@overload
def spdiags[SCT: _Numeric](
    data: _ToArray1D2D[SCT], diags: _Offsets, m: tuple[int, int] | None = None, n: None = None, *, format: _FmtCSR
) -> csr_matrix[SCT]: ...
@overload
def spdiags[SCT: _Numeric](
    data: _ToArray1D2D[SCT], diags: _Offsets, m: tuple[int, int] | None = None, n: None = None, *, format: _FmtDOK
) -> dok_matrix[SCT]: ...
@overload
def spdiags[SCT: _Numeric](
    data: _ToArray1D2D[SCT], diags: _Offsets, m: tuple[int, int] | None = None, n: None = None, *, format: _FmtLIL
) -> lil_matrix[SCT]: ...
...
def identity[SCT: _Numeric](n: int, dtype: onp.ToDType[SCT], format: _FmtDIA | None = None) -> dia_matrix[SCT]: ...
@overload  # dtype: <known>, format: "bsr"
def identity[SCT: _Numeric](n: int, dtype: onp.ToDType[SCT], format: _FmtBSR) -> bsr_matrix[SCT]: ...
@overload  # dtype: <known>, format: "coo"
def identity[SCT: _Numeric](n: int, dtype: onp.ToDType[SCT], format: _FmtCOO) -> coo_matrix[SCT]: ...
@overload  # dtype: <known>, format: "csc"
def identity[SCT: _Numeric](n: int, dtype: onp.ToDType[SCT], format: _FmtCSC) -> csc_matrix[SCT]: ...
@overload  # dtype: <known>, format: "csr"
def identity[SCT: _Numeric](n: int, dtype: onp.ToDType[SCT], format: _FmtCSR) -> csr_matrix[SCT]: ...
@overload  # dtype: <known>, format: "dok"
def identity[SCT: _Numeric](n: int, dtype: onp.ToDType[SCT], format: _FmtDOK) -> dok_matrix[SCT]: ...
@overload  # dtype: <known>, format: "lil"
def identity[SCT: _Numeric](n: int, dtype: onp.ToDType[SCT], format: _FmtLIL) -> lil_matrix[SCT]: ...
...
#
@overload  # dtype: <known>, format: "dia" | None
def eye_array[SCT: _Numeric](
    m: int, n: int | None = None, *, k: int = 0, dtype: onp.ToDType[SCT], format: _FmtDIA | None = None
) -> dia_array[SCT]: ...
@overload  # dtype: <known>, format: "bsr"
def eye_array[SCT: _Numeric](
    m: int, n: int | None = None, *, k: int = 0, dtype: onp.ToDType[SCT], format: _FmtBSR
) -> bsr_array[SCT]: ...
@overload  # dtype: <known>, format: "coo"
def eye_array[SCT: _Numeric](
    m: int, n: int | None = None, *, k: int = 0, dtype: onp.ToDType[SCT], format: _FmtCOO
) -> _COOArray2D[SCT]: ...
@overload  # dtype: <known>, format: "csc"
def eye_array[SCT: _Numeric](
    m: int, n: int | None = None, *, k: int = 0, dtype: onp.ToDType[SCT], format: _FmtCSC
) -> csc_array[SCT]: ...
@overload  # dtype: <known>, format: "csr"
def eye_array[SCT: _Numeric](
    m: int, n: int | None = None, *, k: int = 0, dtype: onp.ToDType[SCT], format: _FmtCSR
) -> _CSRArray2D[SCT]: ...
@overload  # dtype: <known>, format: "dok"
def eye_array[SCT: _Numeric](
    m: int, n: int | None = None, *, k: int = 0, dtype: onp.ToDType[SCT], format: _FmtDOK
) -> _DOKArray2D[SCT]: ...
@overload  # dtype: <known>, format: "lil"
def eye_array[SCT: _Numeric](
    m: int, n: int | None = None, *, k: int = 0, dtype: onp.ToDType[SCT], format: _FmtLIL
) -> lil_array[SCT]: ...
...
def kron[SCT: _Numeric](A: _ToSpMatrix[SCT], B: _ToSpMatrix[SCT], format: _FmtBSR | None = None) -> bsr_matrix[SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "coo"
def kron[SCT: _Numeric](A: _ToSpMatrix[SCT], B: _ToSpMatrix[SCT], format: _FmtCOO) -> coo_matrix[SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "csc"
def kron[SCT: _Numeric](A: _ToSpMatrix[SCT], B: _ToSpMatrix[SCT], format: _FmtCSC) -> csc_matrix[SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "csr"
def kron[SCT: _Numeric](A: _ToSpMatrix[SCT], B: _ToSpMatrix[SCT], format: _FmtCSR) -> csr_matrix[SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "dia"
def kron[SCT: _Numeric](A: _ToSpMatrix[SCT], B: _ToSpMatrix[SCT], format: _FmtDIA) -> dia_matrix[SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "dok"
def kron[SCT: _Numeric](A: _ToSpMatrix[SCT], B: _ToSpMatrix[SCT], format: _FmtDOK) -> dok_matrix[SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "lil"
def kron[SCT: _Numeric](A: _ToSpMatrix[SCT], B: _ToSpMatrix[SCT], format: _FmtLIL) -> lil_matrix[SCT]: ...

#
@overload  # A: sparray, B: 2D sparse, format: "bsr" | None
def kron[SCT: _Numeric](
    A: sparray[SCT, tuple[int, int]], B: _ToSparse2D[SCT], format: _FmtBSR | None = None
) -> bsr_array[SCT]: ...
@overload  # A: sparray, B: sparse, format: "coo"
def kron[SCT: _Numeric](A: sparray[SCT, tuple[int, int]], B: _ToSparse2D[SCT], format: _FmtCOO) -> _COOArray2D[SCT]: ...
@overload  # A: sparray, B: sparse, format: "csc"
def kron[SCT: _Numeric](A: sparray[SCT, tuple[int, int]], B: _ToSparse2D[SCT], format: _FmtCSC) -> csc_array[SCT]: ...
@overload  # A: sparray, B: sparse, format: "csr"
def kron[SCT: _Numeric](A: sparray[SCT, tuple[int, int]], B: _ToSparse2D[SCT], format: _FmtCSR) -> _CSRArray2D[SCT]: ...
@overload  # A: sparray, B: sparse, format: "dia"
def kron[SCT: _Numeric](A: sparray[SCT, tuple[int, int]], B: _ToSparse2D[SCT], format: _FmtDIA) -> dia_array[SCT]: ...
@overload  # A: sparray, B: sparse, format: "dok"
def kron[SCT: _Numeric](A: sparray[SCT, tuple[int, int]], B: _ToSparse2D[SCT], format: _FmtDOK) -> _DOKArray2D[SCT]: ...
@overload  # A: sparray, B: sparse, format: "lil"
def kron[SCT: _Numeric](A: sparray[SCT, tuple[int, int]], B: _ToSparse2D[SCT], format: _FmtLIL) -> lil_array[SCT]: ...

#
@overload  # A: sparse, B: sparray, format: "bsr" | None
def kron[SCT: _Numeric](
    A: _ToSparse2D[SCT], B: sparray[SCT, tuple[int, int]], format: _FmtBSR | None = None
) -> bsr_array[SCT]: ...
@overload  # A: sparray, B: sparse, format: "coo"
def kron[SCT: _Numeric](A: _ToSparse2D[SCT], B: sparray[SCT, tuple[int, int]], format: _FmtCOO) -> _COOArray2D[SCT]: ...
@overload  # A: sparray, B: sparse, format: "csc"
def kron[SCT: _Numeric](A: _ToSparse2D[SCT], B: sparray[SCT, tuple[int, int]], format: _FmtCSC) -> csc_array[SCT]: ...
@overload  # A: sparray, B: sparse, format: "csr"
def kron[SCT: _Numeric](A: _ToSparse2D[SCT], B: sparray[SCT, tuple[int, int]], format: _FmtCSR) -> _CSRArray2D[SCT]: ...
@overload  # A: sparray, B: sparse, format: "dia"
def kron[SCT: _Numeric](A: _ToSparse2D[SCT], B: sparray[SCT, tuple[int, int]], format: _FmtDIA) -> dia_array[SCT]: ...
@overload  # A: sparray, B: sparse, format: "dok"
def kron[SCT: _Numeric](A: _ToSparse2D[SCT], B: sparray[SCT, tuple[int, int]], format: _FmtDOK) -> _DOKArray2D[SCT]: ...
@overload  # A: sparray, B: sparse, format: "lil"
def kron[SCT: _Numeric](A: _ToSparse2D[SCT], B: sparray[SCT, tuple[int, int]], format: _FmtLIL) -> lil_array[SCT]: ...
...
def kronsum[SCT: _Numeric](A: _ToSpMatrix[SCT], B: _ToSpMatrix[SCT], format: _FmtCSR | None = None) -> csr_matrix[SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "bsr"
def kronsum[SCT: _Numeric](A: _ToSpMatrix[SCT], B: _ToSpMatrix[SCT], format: _FmtBSR) -> bsr_matrix[SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "coo"
def kronsum[SCT: _Numeric](A: _ToSpMatrix[SCT], B: _ToSpMatrix[SCT], format: _FmtCOO) -> coo_matrix[SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "csc"
def kronsum[SCT: _Numeric](A: _ToSpMatrix[SCT], B: _ToSpMatrix[SCT], format: _FmtCSC) -> csc_matrix[SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "dia"
def kronsum[SCT: _Numeric](A: _ToSpMatrix[SCT], B: _ToSpMatrix[SCT], format: _FmtDIA) -> dia_matrix[SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "dok"
def kronsum[SCT: _Numeric](A: _ToSpMatrix[SCT], B: _ToSpMatrix[SCT], format: _FmtDOK) -> dok_matrix[SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "lil"
def kronsum[SCT: _Numeric](A: _ToSpMatrix[SCT], B: _ToSpMatrix[SCT], format: _FmtLIL) -> lil_matrix[SCT]: ...

#
@overload  # A: sparray, B: sparse, format: "csr" | None
def kronsum[SCT: _Numeric](
    A: sparray[SCT, tuple[int, int]], B: _ToSparse2D[SCT], format: _FmtCSR | None = None
) -> _CSRArray2D[SCT]: ...
@overload  # A: sparray, B: sparse, format: "bsr"
def kronsum[SCT: _Numeric](A: sparray[SCT, tuple[int, int]], B: _ToSparse2D[SCT], format: _FmtBSR) -> bsr_array[SCT]: ...
@overload  # A: sparray, B: sparse, format: "coo"
def kronsum[SCT: _Numeric](A: sparray[SCT, tuple[int, int]], B: _ToSparse2D[SCT], format: _FmtCOO) -> _COOArray2D[SCT]: ...
@overload  # A: sparray, B: sparse, format: "csc"
def kronsum[SCT: _Numeric](A: sparray[SCT, tuple[int, int]], B: _ToSparse2D[SCT], format: _FmtCSC) -> csc_array[SCT]: ...
@overload  # A: sparray, B: sparse, format: "dia"
def kronsum[SCT: _Numeric](A: sparray[SCT, tuple[int, int]], B: _ToSparse2D[SCT], format: _FmtDIA) -> dia_array[SCT]: ...
@overload  # A: sparray, B: sparse, format: "dok"
def kronsum[SCT: _Numeric](A: sparray[SCT, tuple[int, int]], B: _ToSparse2D[SCT], format: _FmtDOK) -> _DOKArray2D[SCT]: ...
@overload  # A: sparray, B: sparse, format: "lil"
def kronsum[SCT: _Numeric](A: sparray[SCT, tuple[int, int]], B: _ToSparse2D[SCT], format: _FmtLIL) -> lil_array[SCT]: ...

#
@overload  # A: sparse, B: sparray, format: "csr" | None
def kronsum[SCT: _Numeric](
    A: _ToSparse2D[SCT], B: sparray[SCT, tuple[int, int]], format: _FmtCSR | None = None
) -> _CSRArray2D[SCT]: ...
@overload  # A: sparse, B: sparray, format: "bsr"
def kronsum[SCT: _Numeric](A: _ToSparse2D[SCT], B: sparray[SCT, tuple[int, int]], format: _FmtBSR) -> bsr_array[SCT]: ...
@overload  # A: sparse, B: sparray, format: "coo"
def kronsum[SCT: _Numeric](A: _ToSparse2D[SCT], B: sparray[SCT, tuple[int, int]], format: _FmtCOO) -> _COOArray2D[SCT]: ...
@overload  # A: sparse, B: sparray, format: "csc"
def kronsum[SCT: _Numeric](A: _ToSparse2D[SCT], B: sparray[SCT, tuple[int, int]], format: _FmtCSC) -> csc_array[SCT]: ...
@overload  # A: sparse, B: sparray, format: "dia"
def kronsum[SCT: _Numeric](A: _ToSparse2D[SCT], B: sparray[SCT, tuple[int, int]], format: _FmtDIA) -> dia_array[SCT]: ...
@overload  # A: sparse, B: sparray, format: "dok"
def kronsum[SCT: _Numeric](A: _ToSparse2D[SCT], B: sparray[SCT, tuple[int, int]], format: _FmtDOK) -> _DOKArray2D[SCT]: ...
@overload  # A: sparse, B: sparray, format: "lil"
def kronsum[SCT: _Numeric](A: _ToSparse2D[SCT], B: sparray[SCT, tuple[int, int]], format: _FmtLIL) -> lil_array[SCT]: ...
@overload  # A: unknown array-like, B: unknown array-like  (catch-all)
...
def hstack[SCT: _Numeric](blocks: Seq[_SpArray2D[SCT]], format: _FmtBSR, dtype: None = None) -> bsr_array[SCT]: ...
@overload  # sparray, format: "coo", dtype: <default>
def hstack[SCT: _Numeric](blocks: Seq[_SpArray2D[SCT]], format: _FmtCOO, dtype: None = None) -> _COOArray2D[SCT]: ...
@overload  # sparray, format: "csc", dtype: <default>
def hstack[SCT: _Numeric](blocks: Seq[_SpArray2D[SCT]], format: _FmtCSC, dtype: None = None) -> csc_array[SCT]: ...
@overload  # sparray, format: "csr", dtype: <default>
def hstack[SCT: _Numeric](blocks: Seq[_SpArray2D[SCT]], format: _FmtCSR, dtype: None = None) -> _CSRArray2D[SCT]: ...
@overload  # sparray, format: "dia", dtype: <default>
def hstack[SCT: _Numeric](blocks: Seq[_SpArray2D[SCT]], format: _FmtDIA, dtype: None = None) -> dia_array[SCT]: ...
@overload  # sparray, format: "dok", dtype: <default>
def hstack[SCT: _Numeric](blocks: Seq[_SpArray2D[SCT]], format: _FmtDOK, dtype: None = None) -> _DOKArray2D[SCT]: ...
@overload  # sparray, format: "lil", dtype: <default>
def hstack[SCT: _Numeric](blocks: Seq[_SpArray2D[SCT]], format: _FmtLIL, dtype: None = None) -> lil_array[SCT]: ...
...
def hstack[SCT: _Numeric, T](blocks: Seq[_CanStackAs[SCT, T]], format: None = None, *, dtype: onp.ToDType[SCT]) -> T: ...
@overload  # sparray, format: "bsr", dtype: <known>
def hstack[SCT: _Numeric](blocks: Seq[sparray], format: _FmtBSR, dtype: onp.ToDType[SCT]) -> bsr_array[SCT]: ...
@overload  # sparray, format: "coo", dtype: <known>
def hstack[SCT: _Numeric](blocks: Seq[sparray], format: _FmtCOO, dtype: onp.ToDType[SCT]) -> _COOArray2D[SCT]: ...
@overload  # sparray, format: "csc", dtype: <known>
def hstack[SCT: _Numeric](blocks: Seq[sparray], format: _FmtCSC, dtype: onp.ToDType[SCT]) -> csc_array[SCT]: ...
@overload  # sparray, format: "csr", dtype: <known>
def hstack[SCT: _Numeric](blocks: Seq[sparray], format: _FmtCSR, dtype: onp.ToDType[SCT]) -> _CSRArray2D[SCT]: ...
@overload  # sparray, format: "dia", dtype: <known>
def hstack[SCT: _Numeric](blocks: Seq[sparray], format: _FmtDIA, dtype: onp.ToDType[SCT]) -> dia_array[SCT]: ...
@overload  # sparray, format: "dok", dtype: <known>
def hstack[SCT: _Numeric](blocks: Seq[sparray], format: _FmtDOK, dtype: onp.ToDType[SCT]) -> _DOKArray2D[SCT]: ...
@overload  # sparray, format: "lil", dtype: <known>
def hstack[SCT: _Numeric](blocks: Seq[sparray], format: _FmtLIL, dtype: onp.ToDType[SCT]) -> lil_array[SCT]: ...
...
@overload  # sparray, format: "bsr", dtype: <default>
def vstack[SCT: _Numeric](blocks: Seq[_SpArray2D[SCT]], format: _FmtBSR, dtype: None = None) -> bsr_array[SCT]: ...
@overload  # sparray, format: "coo", dtype: <default>
def vstack[SCT: _Numeric](blocks: Seq[_SpArray2D[SCT]], format: _FmtCOO, dtype: None = None) -> _COOArray2D[SCT]: ...
@overload  # sparray, format: "csc", dtype: <default>
def vstack[SCT: _Numeric](blocks: Seq[_SpArray2D[SCT]], format: _FmtCSC, dtype: None = None) -> csc_array[SCT]: ...
@overload  # sparray, format: "csr", dtype: <default>
def vstack[SCT: _Numeric](blocks: Seq[_SpArray2D[SCT]], format: _FmtCSR, dtype: None = None) -> _CSRArray2D[SCT]: ...
@overload  # sparray, format: "dia", dtype: <default>
def vstack[SCT: _Numeric](blocks: Seq[_SpArray2D[SCT]], format: _FmtDIA, dtype: None = None) -> dia_array[SCT]: ...
@overload  # sparray, format: "dok", dtype: <default>
def vstack[SCT: _Numeric](blocks: Seq[_SpArray2D[SCT]], format: _FmtDOK, dtype: None = None) -> _DOKArray2D[SCT]: ...
@overload  # sparray, format: "lil", dtype: <default>
def vstack[SCT: _Numeric](blocks: Seq[_SpArray2D[SCT]], format: _FmtLIL, dtype: None = None) -> lil_array[SCT]: ...
...
#
@overload  # sparray, format: <default>, dtype: <known>
def vstack[SCT: _Numeric, T](blocks: Seq[_CanStackAs[SCT, T]], format: None = None, *, dtype: onp.ToDType[SCT]) -> T: ...
@overload  # sparray, format: "bsr", dtype: <known>
def vstack[SCT: _Numeric](blocks: Seq[sparray], format: _FmtBSR, dtype: onp.ToDType[SCT]) -> bsr_array[SCT]: ...
@overload  # sparray, format: "coo", dtype: <known>
def vstack[SCT: _Numeric](blocks: Seq[sparray], format: _FmtCOO, dtype: onp.ToDType[SCT]) -> _COOArray2D[SCT]: ...
@overload  # sparray, format: "csc", dtype: <known>
def vstack[SCT: _Numeric](blocks: Seq[sparray], format: _FmtCSC, dtype: onp.ToDType[SCT]) -> csc_array[SCT]: ...
@overload  # sparray, format: "csr", dtype: <known>
def vstack[SCT: _Numeric](blocks: Seq[sparray], format: _FmtCSR, dtype: onp.ToDType[SCT]) -> _CSRArray2D[SCT]: ...
@overload  # sparray, format: "dia", dtype: <known>
def vstack[SCT: _Numeric](blocks: Seq[sparray], format: _FmtDIA, dtype: onp.ToDType[SCT]) -> dia_array[SCT]: ...
@overload  # sparray, format: "dok", dtype: <known>
def vstack[SCT: _Numeric](blocks: Seq[sparray], format: _FmtDOK, dtype: onp.ToDType[SCT]) -> _DOKArray2D[SCT]: ...
@overload  # sparray, format: "lil", dtype: <known>
def vstack[SCT: _Numeric](blocks: Seq[sparray], format: _FmtLIL, dtype: onp.ToDType[SCT]) -> lil_array[SCT]: ...
...
def block_array[SCT: _Numeric](blocks: _ToBlocksSpArray[SCT], *, format: _FmtBSR, dtype: None = None) -> bsr_array[SCT]: ...
@overload  # blocks: <array, known>, format: "coo", dtype: <default>
def block_array[SCT: _Numeric](blocks: _ToBlocksSpArray[SCT], *, format: _FmtCOO, dtype: None = None) -> _COOArray2D[SCT]: ...
@overload  # blocks: <array, known>, format: "csc", dtype: <default>
def block_array[SCT: _Numeric](blocks: _ToBlocksSpArray[SCT], *, format: _FmtCSC, dtype: None = None) -> csc_array[SCT]: ...
@overload  # blocks: <array, known>, format: "csr", dtype: <default>
def block_array[SCT: _Numeric](blocks: _ToBlocksSpArray[SCT], *, format: _FmtCSR, dtype: None = None) -> _CSRArray2D[SCT]: ...
@overload  # blocks: <array, known>, format: "dia", dtype: <default>
def block_array[SCT: _Numeric](blocks: _ToBlocksSpArray[SCT], *, format: _FmtDIA, dtype: None = None) -> dia_array[SCT]: ...
@overload  # blocks: <array, known>, format: "dok", dtype: <default>
def block_array[SCT: _Numeric](blocks: _ToBlocksSpArray[SCT], *, format: _FmtDOK, dtype: None = None) -> _DOKArray2D[SCT]: ...
@overload  # blocks: <array, known>, format: "lil", dtype: <default>
def block_array[SCT: _Numeric](blocks: _ToBlocksSpArray[SCT], *, format: _FmtLIL, dtype: None = None) -> lil_array[SCT]: ...
...
def block_array[SCT: _Numeric, T](blocks: _ToBlocksCanStackAs[SCT, T], *, format: None = None, dtype: onp.ToDType[SCT]) -> T: ...
@overload  # blocks: <unknown, unknown>, format: "bsr", dtype: <known>
def block_array[SCT: _Numeric](blocks: _ToBlocksUnkown, *, format: _FmtBSR, dtype: onp.ToDType[SCT]) -> bsr_array[SCT]: ...
@overload  # blocks: <unknown, unknown>, format: "coo", dtype: <known>
def block_array[SCT: _Numeric](blocks: _ToBlocksUnkown, *, format: _FmtCOO, dtype: onp.ToDType[SCT]) -> _COOArray2D[SCT]: ...
@overload  # blocks: <unknown, unknown>, format: "csc", dtype: <known>
def block_array[SCT: _Numeric](blocks: _ToBlocksUnkown, *, format: _FmtCSC, dtype: onp.ToDType[SCT]) -> csc_array[SCT]: ...
@overload  # blocks: <unknown, unknown>, format: "csr", dtype: <known>
def block_array[SCT: _Numeric](blocks: _ToBlocksUnkown, *, format: _FmtCSR, dtype: onp.ToDType[SCT]) -> _CSRArray2D[SCT]: ...
@overload  # blocks: <unknown, unknown>, format: "dia", dtype: <known>
def block_array[SCT: _Numeric](blocks: _ToBlocksUnkown, *, format: _FmtDIA, dtype: onp.ToDType[SCT]) -> dia_array[SCT]: ...
@overload  # blocks: <unknown>, format: "dok", dtype: <known>
def block_array[SCT: _Numeric](blocks: _ToBlocksUnkown, *, format: _FmtDOK, dtype: onp.ToDType[SCT]) -> _DOKArray2D[SCT]: ...
@overload  # blocks: <unknown, unknown>, format: "lil", dtype: <known>
def block_array[SCT: _Numeric](blocks: _ToBlocksUnkown, *, format: _FmtLIL, dtype: onp.ToDType[SCT]) -> lil_array[SCT]: ...
...
def bmat[SCT: _Numeric](blocks: _ToBlocks[spmatrix[SCT]], format: _Format, dtype: None = None) -> spmatrix[SCT]: ...

#
@overload  # blocks: <known, known>, format: <default>, dtype: <known>
def bmat[SCT: _Numeric, T](blocks: _ToBlocksCanStackAs[SCT, T], format: None = None, *, dtype: onp.ToDType[SCT]) -> T: ...
@overload  # blocks: <matrix, known>, format: <otherwise>, dtype: <known>
def bmat[SCT: _Numeric](blocks: _ToBlocks[spmatrix[SCT]], format: _Format, dtype: onp.ToDType[SCT]) -> spmatrix[SCT]: ...
@overload  # blocks: <unknown, unknown>, format: <otherwise>, dtype: <known>
def bmat[SCT: _Numeric](blocks: _ToBlocksUnkown, format: _Format, dtype: onp.ToDType[SCT]) -> spmatrix[SCT] | _SpArray2D[SCT]: ...
...
def block_diag[SCT: _Numeric](
    mats: Iterable[sparray[SCT]], format: _FmtCOO | None = None, dtype: None = None
) -> _COOArray2D[SCT]: ...
@overload  # mats: <array, known>, format: "bsr", dtype: None
def block_diag[SCT: _Numeric](mats: Iterable[sparray[SCT]], format: _FmtBSR, dtype: None = None) -> bsr_array[SCT]: ...
@overload  # mats: <array, known>, format: "csc", dtype: None
def block_diag[SCT: _Numeric](mats: Iterable[sparray[SCT]], format: _FmtCSC, dtype: None = None) -> csc_array[SCT]: ...
@overload  # mats: <array, known>, format: "csr", dtype: None
def block_diag[SCT: _Numeric](mats: Iterable[sparray[SCT]], format: _FmtCSR, dtype: None = None) -> _CSRArray2D[SCT]: ...
@overload  # mats: <array, known>, format: "dia", dtype: None
def block_diag[SCT: _Numeric](mats: Iterable[sparray[SCT]], format: _FmtDIA, dtype: None = None) -> dia_array[SCT]: ...
@overload  # mats: <array, known>, format: "dok", dtype: None
def block_diag[SCT: _Numeric](mats: Iterable[sparray[SCT]], format: _FmtDOK, dtype: None = None) -> _DOKArray2D[SCT]: ...
@overload  # mats: <array, known>, format: "lil", dtype: None
def block_diag[SCT: _Numeric](mats: Iterable[sparray[SCT]], format: _FmtLIL, dtype: None = None) -> lil_array[SCT]: ...
...
def block_diag[SCT: _Numeric](
    mats: Iterable[sparray], format: _FmtCOO | None = None, *, dtype: onp.ToDType[SCT]
) -> _COOArray2D[SCT]: ...
@overload  # mats: <array, unknown>, format: "bsr", dtype: <known>
def block_diag[SCT: _Numeric](mats: Iterable[sparray], format: _FmtBSR, dtype: onp.ToDType[SCT]) -> bsr_array[SCT]: ...
@overload  # mats: <array, unknown>, format: "csc", dtype: <known>
def block_diag[SCT: _Numeric](mats: Iterable[sparray], format: _FmtCSC, dtype: onp.ToDType[SCT]) -> csc_array[SCT]: ...
@overload  # mats: <array, unknown>, format: "csr", dtype: <known>
def block_diag[SCT: _Numeric](mats: Iterable[sparray], format: _FmtCSR, dtype: onp.ToDType[SCT]) -> _CSRArray2D[SCT]: ...
@overload  # mats: <array, unknown>, format: "dia", dtype: <known>
def block_diag[SCT: _Numeric](mats: Iterable[sparray], format: _FmtDIA, dtype: onp.ToDType[SCT]) -> dia_array[SCT]: ...
@overload  # mats: <array, unknown>, format: "dok", dtype: <known>
def block_diag[SCT: _Numeric](mats: Iterable[sparray], format: _FmtDOK, dtype: onp.ToDType[SCT]) -> _DOKArray2D[SCT]: ...
@overload  # mats: <array, unknown>, format: "lil", dtype: <known>
def block_diag[SCT: _Numeric](mats: Iterable[sparray], format: _FmtLIL, dtype: onp.ToDType[SCT]) -> lil_array[SCT]: ...

#
@overload  # mats: <unknown, known>, format: <default>, dtype: None
def block_diag[SCT: _Numeric](
    mats: _ToMatsDiag[SCT], format: _FmtCOO | None = None, dtype: None = None
) -> _COOArray2D[SCT] | coo_matrix[SCT]: ...
@overload  # mats: <unknown, known>, format: "bsr", dtype: None
def block_diag[SCT: _Numeric](
    mats: _ToMatsDiag[SCT], format: _FmtBSR, dtype: None = None
) -> bsr_array[SCT] | bsr_matrix[SCT]: ...
@overload  # mats: <unknown, known>, format: "csc", dtype: None
def block_diag[SCT: _Numeric](
    mats: _ToMatsDiag[SCT], format: _FmtCSC, dtype: None = None
) -> csc_array[SCT] | csc_matrix[SCT]: ...
@overload  # mats: <unknown, known>, format: "csr", dtype: None
def block_diag[SCT: _Numeric](
    mats: _ToMatsDiag[SCT], format: _FmtCSR, dtype: None = None
) -> _CSRArray2D[SCT] | csr_matrix[SCT]: ...
@overload  # mats: <unknown, known>, format: "dia", dtype: None
def block_diag[SCT: _Numeric](
    mats: _ToMatsDiag[SCT], format: _FmtDIA, dtype: None = None
) -> dia_array[SCT] | dia_matrix[SCT]: ...
@overload  # mats: <unknown, known>, format: "dok", dtype: None
def block_diag[SCT: _Numeric](
    mats: _ToMatsDiag[SCT], format: _FmtDOK, dtype: None = None
) -> _DOKArray2D[SCT] | dok_matrix[SCT]: ...
@overload  # mats: <unknown, known>, format: "lil", dtype: None
def block_diag[SCT: _Numeric](
    mats: _ToMatsDiag[SCT], format: _FmtLIL, dtype: None = None
) -> lil_array[SCT] | lil_matrix[SCT]: ...

#
@overload  # mats: <unknown, unknown>, format: <default>, dtype: <known>
def block_diag[SCT: _Numeric](
    mats: _ToMatsDiagUnknown, format: _FmtCOO | None = None, *, dtype: onp.ToDType[SCT]
) -> _COOArray2D[SCT] | coo_matrix[SCT]: ...
@overload  # mats: <unknown, unknown>, format: "bsr", dtype: <known>
def block_diag[SCT: _Numeric](
    mats: _ToMatsDiagUnknown, format: _FmtBSR, dtype: onp.ToDType[SCT]
) -> bsr_array[SCT] | bsr_matrix[SCT]: ...
@overload  # mats: <unknown, unknown>, format: "csc", dtype: <known>
def block_diag[SCT: _Numeric](
    mats: _ToMatsDiagUnknown, format: _FmtCSC, dtype: onp.ToDType[SCT]
) -> csc_array[SCT] | csc_matrix[SCT]: ...
@overload  # mats: <unknown, unknown>, format: "csr", dtype: <known>
def block_diag[SCT: _Numeric](
    mats: _ToMatsDiagUnknown, format: _FmtCSR, dtype: onp.ToDType[SCT]
) -> _CSRArray2D[SCT] | csr_matrix[SCT]: ...
@overload  # mats: <unknown, unknown>, format: "dia", dtype: <known>
def block_diag[SCT: _Numeric](
    mats: _ToMatsDiagUnknown, format: _FmtDIA, dtype: onp.ToDType[SCT]
) -> dia_array[SCT] | dia_matrix[SCT]: ...
@overload  # mats: <unknown, unknown>, format: "dok", dtype: <known>
def block_diag[SCT: _Numeric](
    mats: _ToMatsDiagUnknown, format: _FmtDOK, dtype: onp.ToDType[SCT]
) -> _DOKArray2D[SCT] | dok_matrix[SCT]: ...
@overload  # mats: <unknown, unknown>, format: "lil", dtype: <known>
def block_diag[SCT: _Numeric](
    mats: _ToMatsDiagUnknown, format: _FmtLIL, dtype: onp.ToDType[SCT]
) -> lil_array[SCT] | lil_matrix[SCT]: ...
...
def random_array[ShapeT: tuple[int, *tuple[int, ...]], SCT: _Numeric](
    shape: ShapeT,
    *,
    density: float | npc.floating = 0.01,
    format: _FmtCOO = "coo",
