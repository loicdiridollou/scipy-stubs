...
#
def _solve_discrete_lyapunov_direct[InexactT: np.float32 | np.float64 | np.complex64 | np.complex128](
    a: onp.Array2D[InexactT], q: onp.Array2D[InexactT]
) -> onp.Array2D[InexactT]: ...
def _solve_discrete_lyapunov_bilinear[InexactT: np.float32 | np.float64 | np.complex64 | np.complex128](
    a: onp.Array2D[InexactT], q: onp.Array2D[InexactT]
) -> onp.Array2D[InexactT]: ...
